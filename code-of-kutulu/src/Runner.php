...
use CodeInGame\CodeOfKutulu\Game;
...
$game = new Game($sanityLossLonely, $sanityLossGroup, $wandererSpawnTime, $wandererLifeTime, $map);
...
while (TRUE)
{
    ...
    for ($i = 0; $i < $entityCount; $i++)
    {
        ...
        if ($i == 0){
            $game->addPlayer($id, $x, $y, $param0, $param1, $param2);
        }else{
            $game->addEntity($entityType, $id, $x, $y, $param0, $param1, $param2);
        }
    }
